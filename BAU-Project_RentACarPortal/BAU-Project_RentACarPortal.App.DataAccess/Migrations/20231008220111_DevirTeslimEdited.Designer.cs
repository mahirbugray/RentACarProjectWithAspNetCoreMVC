...
namespace BAU_Project_RentACarPortal.App.DataAccess.Migrations
{
    ...
    [Migration("20231008220111_DevirTeslimEdited")]
    partial class DevirTeslimEdited
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BAU_Project_RentACarPortal.App.Entity.Entities.Devir", b =>
                {
                    ...
                    b.Property<int>("KiralamaDetayId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BAU_Project_RentACarPortal.App.Entity.Entities.Devir", b =>
                {
                    b.HasOne("BAU_Project_RentACarPortal.App.Entity.Entities.KiralamaDetay", "KiralamaDetay")
                        .WithOne("Devir")
                        .HasForeignKey("BAU_Project_RentACarPortal.App.Entity.Entities.Devir", "KiralamaDetayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BAU_Project_RentACarPortal.App.Entity.Entities.Teslim", b =>
                {
                    b.HasOne("BAU_Project_RentACarPortal.App.Entity.Entities.KiralamaDetay", "KiralamaDetay")
                        .WithOne("Teslim")
                        .HasForeignKey("BAU_Project_RentACarPortal.App.Entity.Entities.Teslim", "KiralamaDetayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
